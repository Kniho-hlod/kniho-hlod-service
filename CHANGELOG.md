...
- 2353ce3: Move to `@eleansphere/entity-core@^2.0.0` and drop the `@eleansphere/service-core` dependency
...
- a65909e: - Bump `@eleansphere/entity-core` to `^1.3.0`. No behaviour change; downstream type-checking of
